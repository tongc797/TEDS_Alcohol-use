...
author: "Tong Chen"
#script for sex difference test in phenotypic models for AUDIT-Problem
---
...
#test sex differences for AUDIT-Problem
#fit model for female, use AUDIT-P score regressed on age, with covariates
ALCmodel1F_cov<-'
ipsanxt1~~icsanxt1
emo41~~dsdcont1
gpsanxt1~~gpscont1
...
QCC~~0*QCC
QCA~~0*QCA
u2calcoauditpragelg1~start(0)*IEC+start(0)*SEC+start(0)*IEA+start(0)*SEA+start(0)*ICC+start(0)*SCC+start(0)*ICA+start(0)*SCA+laethnic+llivs21+lrel21+lstatus21D1+lstatus21D2+lases+lu1chqualp1+lu1pchild1
laethnic=~1*aethnic
aethnic~~0*aethnic
llivs21=~1*livs21
livs21~~0*livs21
...
#fit model for male, use AUDIT-P score regressed on age, with covariates
ALCmodel1M_cov<-'
ipsanxt1~~icsanxt1
emo41~~dsdcont1
gpsanxt1~~gpscont1
...
#r multi-group models
#use AUDIT-P score regressed on age, with covariates
ALCmodel1_cov_mg<-'
ipsanxt1~~icsanxt1
emo41~~dsdcont1
gpsanxt1~~gpscont1
...
QCC~~0*QCC
QCA~~0*QCA
u2calcoauditpragelg1~start(0)*IEC+start(0)*SEC+start(0)*IEA+start(0)*SEA+start(0)*ICC+start(0)*SCC+start(0)*ICA+start(0)*SCA+start(0)*laethnic+start(0)*llivs21+start(0)*lrel21+start(0)*lstatus21D1+start(0)*lstatus21D2+start(0)*lases+start(0)*lu1chqualp1+start(0)*lu1pchild1
laethnic=~1*aethnic
aethnic~~0*aethnic
llivs21=~1*livs21
livs21~~0*livs21
...
ALCmodel1_cov_mg2<-cfa(ALCmodel1_cov_mg2,data=TEDS,estimator="MLR",missing='ML',cluster="randomfamid",meanstructure=TRUE,group="sex1",
                       ...
                       group.partial = c("IEC~~IEC", "SEC~~SEC","IEA~~IEA", "SEA~~SEA","ICC~~ICC", "SCC~~SCC","ICA~~ICA", "SCA~~SCA","IEC~1","SEC~1","IEA~1","SEA~1","ICC~1","SCC~1","ICA~1","SCA~1","QEC~1","QEA~1","QCC~1","QCA~1","u2calcoauditpragelg1~1","IEC~~IEA","IEC~~SEA","IEC~~ICC","IEC~~ICA","IEC~~SCA","SEC~~IEA","SEC~~ICC","SEC~~ICA","IEA~~SEA","IEA~~ICC","IEA~~ICA","IEA~~SCA","SEA~~ICC","SEA~~ICA","SEA~~SCA","ICC~~SCC","ICC~~ICA","ICC~~SCA","SCC~~ICA","SCC~~SCA","ICA~~SCA"))
...
ALCmodel1_cov_mg3i4_5_7_12_1_2_3_10<-cfa(ALCmodel1_cov_mg3,data=TEDS,estimator="MLR",missing='ML',cluster="randomfamid",meanstructure=TRUE,group="sex1",
                                         group.equal = c("lv.variances","intercepts","means","lv.covariances"),
                                         group.partial = c("IEC~~IEC", "SEC~~SEC","IEA~~IEA", "SEA~~SEA","ICC~~ICC", "SCC~~SCC","ICA~~ICA", "SCA~~SCA","u2calcoauditpragelg1~1","IEC~~IEA","IEC~~SEA","IEC~~ICC","IEC~~ICA","IEC~~SCA","SEC~~IEA","SEC~~ICC","SEC~~ICA","IEA~~SEA","IEA~~ICC","IEA~~ICA","IEA~~SCA","SEA~~ICC","SEA~~ICA","SEA~~SCA","ICC~~SCC","ICC~~ICA","ICC~~SCA","SCC~~ICA","SCC~~SCA","ICA~~SCA","QEA~1","SEA~1","ICC~1","ICA~1","QCA~1","IEC~1","SEC~1","IEA~1"))
...
ALCmodel1_cov_mg4v7_5_6_2_3<-cfa(ALCmodel1_cov_mg4,data=TEDS,estimator="MLR",missing='ML',cluster="randomfamid",meanstructure=TRUE,group="sex1",
                                 group.equal = c("lv.variances","intercepts","means","lv.covariances"),
                                 group.partial = c("u2calcoauditpragelg1~1","IEC~~IEA","IEC~~SEA","IEC~~ICC","IEC~~ICA","IEC~~SCA","SEC~~IEA","SEC~~ICC","SEC~~ICA","IEA~~SEA","IEA~~ICC","IEA~~ICA","IEA~~SCA","SEA~~ICC","SEA~~ICA","SEA~~SCA","ICC~~SCC","ICC~~ICA","ICC~~SCA","SCC~~ICA","SCC~~SCA","ICA~~SCA","QEA~1","SEA~1","ICC~1","ICA~1","QCA~1","IEC~1","SEC~1","IEA~1","IEA~~IEA","ICA~~ICA","ICC~~ICC","SCC~~SCC","SEC~~SEC"))
...
ALCmodel1_cov_mg5cv17_18_6_21_19<-cfa(ALCmodel1_cov_mg5,data=TEDS,estimator="MLR",missing='ML',cluster="randomfamid",meanstructure=TRUE,group="sex1",
                                      group.equal = c("lv.variances","intercepts","means","lv.covariances"),
                                      group.partial = c("u2calcoauditpragelg1~1","QEA~1","SEA~1","ICC~1","ICA~1","QCA~1","IEC~1","SEC~1","IEA~1","IEA~~IEA","ICA~~ICA","ICC~~ICC","SCC~~SCC","SEC~~SEC","SCC~~ICA","ICC~~ICA","ICC~~SCA","SEC~~IEA","ICA~~SCA"))
...
ALCmodel1_cov_mg6v6_11_8_10<-cfa(ALCmodel1_cov_mg6,data=TEDS,estimator="MLR",missing='ML',cluster="randomfamid",meanstructure=TRUE,group="sex1",
                                 ...
                                 group.partial = c("u2calcoauditpragelg1~1","u2calcoauditpragelg1~~u2calcoauditpragelg1","QEA~1","SEA~1","ICC~1","ICA~1","QCA~1","IEC~1","SEC~1","IEA~1","IEA~~IEA","ICA~~ICA","ICC~~ICC","SCC~~SCC","SEC~~SEC","SCC~~ICA","ICC~~ICA","ICC~~SCA","SEC~~IEA","ICA~~SCA","icscont1~~icscont1","pcbhsdqemot1~~pcbhsdqemot1","lcsdqcont1~~lcsdqcont1","gpscont1~~gpscont1"))
...
QCC~~0*QCC
QCA~~0*QCA
u2calcoauditpragelg1~start(0)*IEC+start(0)*SEC+start(0)*IEA+start(0)*SEA+start(0)*ICC+start(0)*SCC+start(0)*ICA+start(0)*SCA+start(0)*laethnic+start(0)*llivs21+start(0)*lrel21+start(0)*lstatus21D1+start(0)*lstatus21D2+start(0)*lases+start(0)*lu1chqualp1+start(0)*lu1pchild1+c(bc1m,bc1f)*laethnic+c(bc2m,bc2f)*llivs21+c(bc3m,bc3f)*lrel21+c(bc4m,bc4f)*lstatus21D1+c(bc5m,bc5f)*lstatus21D2+c(bc6m,bc6f)*lases+c(bc7m,bc7f)*lu1chqualp1+c(bc8m,bc8f)*lu1pchild1+c(b1m,b1f)*IEC+c(b2m,b2f)*SEC+c(b3m,b3f)*IEA+c(b4m,b4f)*SEA+c(b5m,b5f)*ICC+c(b6m,b6f)*SCC+c(b7m,b7f)*ICA+c(b8m,b8f)*SCA
laethnic=~1*aethnic
aethnic~~0*aethnic
llivs21=~1*livs21
livs21~~0*livs21
...
lavTestWald(ALCmodel1_cov_mg7r, constraints = "b3f-b3m == 0")
...
QCC~~0*QCC
QCA~~0*QCA
u2calcoauditpragelg1~start(0)*IEC+start(0)*SEC+start(0)*IEA+start(0)*SEA+start(0)*ICC+start(0)*SCC+start(0)*ICA+start(0)*SCA+start(0)*laethnic+start(0)*llivs21+start(0)*lrel21+start(0)*lstatus21D1+start(0)*lstatus21D2+start(0)*lases+start(0)*lu1chqualp1+start(0)*lu1pchild1+c(bc1,bc1)*laethnic+c(bc2,bc2)*llivs21+c(bc3m,bc3f)*lrel21+c(bc4m,bc4f)*lstatus21D1+c(bc5,bc5)*lstatus21D2+c(bc6,bc6)*lases+c(bc7m,bc7f)*lu1chqualp1+c(bc8,bc8)*lu1pchild1+c(b1,b1)*IEC+c(b2,b2)*SEC+c(b3,b3)*IEA+c(b4,b4)*SEA+c(b5,b5)*ICC+c(b6,b6)*SCC+c(b7,b7)*ICA+c(b8,b8)*SCA
laethnic=~1*aethnic
aethnic~~0*aethnic
llivs21=~1*livs21
livs21~~0*livs21
...
QCC~~0*QCC
QCA~~0*QCA
u2calcoauditpragelg1~start(0)*IEC+start(0)*SEC+start(0)*IEA+start(0)*SEA+start(0)*ICC+start(0)*SCC+start(0)*ICA+start(0)*SCA+start(0)*laethnic+start(0)*llivs21+start(0)*lrel21+start(0)*lstatus21D1+start(0)*lstatus21D2+start(0)*lases+start(0)*lu1chqualp1+start(0)*lu1pchild1+c(bc1,bc1)*laethnic+c(bc2,bc2)*llivs21+c(bc3m,bc3f)*lrel21+c(bc4m,bc4f)*lstatus21D1+c(bc5,bc5)*lstatus21D2+c(bc6,bc6)*lases+c(bc7,bc7)*lu1chqualp1+c(bc8,bc8)*lu1pchild1+c(b1,b1)*IEC+c(b2,b2)*SEC+c(b3,b3)*IEA+c(b4,b4)*SEA+c(b5,b5)*ICC+c(b6,b6)*SCC+c(b7,b7)*ICA+c(b8,b8)*SCA
laethnic=~1*aethnic
aethnic~~0*aethnic
llivs21=~1*livs21
livs21~~0*livs21
...
lavTestWald(ALCmodel1_cov_mg7r3, constraints = "bc4f-bc4m == 0")#sig
...
#constrain covariances of latent growth variables, free up "SCC~~ICA","ICC~~ICA","ICC~~SCA","SEC~~IEA","ICA~~SCA"
#constrain residual variances and covariances of indicators of latent growth variables, free up "icscont1~~icscont1","pcbhsdqemot1~~pcbhsdqemot1","lcsdqcont1~~lcsdqcont1","gpscont1~~gpscont1"
#regressions coefficients constrainted except for rel21,status21D1
#constrain intercept and residual variance of AUDIT-P
ALCmodel1_cov_mg8<-'
ipsanxt1~~icsanxt1
emo41~~dsdcont1
gpsanxt1~~gpscont1
...
anova(ALCmodel1_cov_mg8,ALCmodel1_cov_mg7r3)#non-sig, this is the final model